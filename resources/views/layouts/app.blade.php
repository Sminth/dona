                        ...
                        <form action="{{ route('paye') }}" method="post">
                            ...
                            <div class="checkbox-wrapper" style="margin-top: 20px;margin-bottom: 20px">
                                ...
                                <label class="terms-label" for="terms-checkbox-37">
                                    ...
                                    <span
                                        onclick="document.getElementById('informe').style.display=='none'?document.getElementById('informe').style.display='block':document.getElementById('informe').style.display='none'"
                                        class="label-text">etre informer des impacts de mon Don</span>
                                </label>
                            </div>
                            ...
                            <div id="informe" style="display: none">
                                <div class="form" style="position: relative;width:100%">
                                    <input class="input" placeholder="Entrez votre mail" type="email">
                                    <span class="input-border"></span>
                                </div>
                                <div class="form" style="position: relative;width:100%">
                                    <input class="input" placeholder="Entrez votre nom (optionnel)" type="text">
                                    <span class="input-border"></span>
                                </div>
                            </div>
                            <center>
    ...
    <script>
        function show(cause) {
            ...
            document.getElementById('donreste').innerText = parseInt(cause['objectif'] ?? 0) - parseInt(cause['collecte'] ??
                0)
            document.getElementById('donpercenttext').innerText = (parseInt(cause['collecte'] ?? 0) / parseInt(cause[
                'objectif'] ?? 0)) * 100
